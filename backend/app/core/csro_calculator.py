...
class CSROCalculator:
    ...
    def calculate_csro(self, coords: np.ndarray, box: np.ndarray, types: np.ndarray,
    ...
    def calculate_warren_cowley(self, coords: np.ndarray, box: np.ndarray, types: np.ndarray,
                                 type1: int, type2: int) -> float:
        result = self.calculate_csro(coords, box, types, type1, type2)
        return result['S_ij']

    def analyze_all_pairs(self, coords: np.ndarray, box: np.ndarray, types: np.ndarray) -> Dict:
